# vrad-Nextgen Test Runner
# Orchestrates sequential execution of CPU-vs-nextgen validation tests
# defined in vrad_nextgen_tests.psd1.
#
# Usage:
#   .\run_vrad_nextgen_tests.ps1 -All                             # Run all tests
#   .\run_vrad_nextgen_tests.ps1 -TestNames radiosity_simple      # Run specific tests
#   .\run_vrad_nextgen_tests.ps1 -Group nextgen                   # Run all tests in a group
#   .\run_vrad_nextgen_tests.ps1 -TestNames radiosity_simple -SkipVisualCheck
...
# --- Load manifest ---
$manifestPath = Join-Path $PSScriptRoot "vrad_nextgen_tests.psd1"
...
elseif ($TestNames -and $TestNames.Count -gt 0) {
    ...
    Write-Host "Usage: run_vrad_nextgen_tests.ps1 -All | -TestNames <name1>,<name2>,... | -Group <group>"
...
$harnessPath = Join-Path $PSScriptRoot "vrad_nextgen_test_harness.ps1"
$results = @{}
$totalStart = Get-Date

Write-Host ""
Write-Host "======================================"
Write-Host "  vrad-Nextgen Test Suite"
